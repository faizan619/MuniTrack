          ...
          <div className={`w-[80%] py-5`}>
            ...
            >
              ...
              {data.issue_state === "pending" ? (
                  ...
                  <p className={`capitalize rounded-md py-2 px-3 `}>Issue Resolved By {data.issue_resolved_by} on <span>{data.issue_resolved_on}</span></p>
                )}
              </div>
                <span
              ...
              <Image
                ...
                height={0}
                width={300}
                className="object-contain border w-full rounded-md border-black"
              />
              ...
              <div className={`bg-gray-800 ${serif.className} text-white p-3 rounded-md`}>
